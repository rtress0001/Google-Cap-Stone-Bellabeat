...
```
Coverting Char into date format
```{r}
...
The second surprise found later in the book is the general trends the postive columns like Total Steps, Distance, Very Active Minutes are all increasing in time, with decrease in sedentary minutes and calories decreasing
